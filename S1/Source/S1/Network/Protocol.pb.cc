...
PROTOBUF_CONSTEXPR C_ENTER_GAME::C_ENTER_GAME(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.room_index_)*/0u
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ENTER_GAME, _impl_.room_index_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.players_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 34, -1, -1, sizeof(::Protocol::S_CREATE_GAME)},
  ...
  { 80, -1, -1, sizeof(::Protocol::C_CHAT)},
  { 87, -1, -1, sizeof(::Protocol::S_CHAT)},
};
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Struct.proto\"\t\n\007C_LOGIN\"\032\n\007S_LOGIN\022\017\n\007su"
  "ccess\030\001 \001(\010\"\"\n\014C_ENTER_GAME\022\022\n\nroom_inde"
  "x\030\001 \001(\r\"E\n\014S_ENTER_GAME\022\017\n\007success\030\001 \001(\010"
  "\022$\n\006player\030\002 \001(\0132\024.Protocol.PlayerInfo\"\017"
  "\n\rC_CREATE_GAME\"\017\n\rS_CREATE_GAME\"\016\n\014C_LE"
  "AVE_GAME\"\016\n\014S_LEAVE_GAME\"0\n\007S_SPAWN\022%\n\007p"
  "layers\030\001 \003(\0132\024.Protocol.PlayerInfo\"\037\n\tS_"
...
C_ENTER_GAME::C_ENTER_GAME(const C_ENTER_GAME& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _this->_impl_.room_index_ = from._impl_.room_index_;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.room_index_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* C_ENTER_GAME::_InternalSerialize(
  ...
  if (this->_internal_room_index() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this->_internal_room_index(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_ENTER_GAME)
  ...
  // uint32 room_index = 1;
  if (this->_internal_room_index() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_room_index());
  }
...
void C_ENTER_GAME::InternalSwap(C_ENTER_GAME* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.room_index_, other->_impl_.room_index_);
}
