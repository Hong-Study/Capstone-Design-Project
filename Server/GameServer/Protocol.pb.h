...
class C_ENTER_GAME final :
 ...
 public:
  ...
  void set_room_index(uint32_t value);
  private:
  uint32_t _internal_room_index() const;
  void _internal_set_room_index(uint32_t value);
  public:
...
class C_CREATE_GAME final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.C_CREATE_GAME) */ {
 public:
  ...
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const C_CREATE_GAME& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
...
class S_CREATE_GAME final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.S_CREATE_GAME) */ {
 public:
  ...
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const S_CREATE_GAME& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
...
// uint32 room_index = 1;
inline void C_ENTER_GAME::clear_room_index() {
  _impl_.room_index_ = 0u;
}
inline uint32_t C_ENTER_GAME::_internal_room_index() const {
  return _impl_.room_index_;
}
inline uint32_t C_ENTER_GAME::room_index() const {
  // @@protoc_insertion_point(field_get:Protocol.C_ENTER_GAME.room_index)
  return _internal_room_index();
}
inline void C_ENTER_GAME::_internal_set_room_index(uint32_t value) {
  
  _impl_.room_index_ = value;
}
inline void C_ENTER_GAME::set_room_index(uint32_t value) {
  _internal_set_room_index(value);
  // @@protoc_insertion_point(field_set:Protocol.C_ENTER_GAME.room_index)
}
...
// repeated .Protocol.PlayerInfo players = 1;
inline int S_MOVE::_internal_players_size() const {
  return _impl_.players_.size();
}
inline int S_MOVE::players_size() const {
  return _internal_players_size();
}
inline ::Protocol::PlayerInfo* S_MOVE::mutable_players(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.S_MOVE.players)
  return _impl_.players_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::PlayerInfo >*
S_MOVE::mutable_players() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.S_MOVE.players)
  return &_impl_.players_;
}
inline const ::Protocol::PlayerInfo& S_MOVE::_internal_players(int index) const {
  return _impl_.players_.Get(index);
}
inline const ::Protocol::PlayerInfo& S_MOVE::players(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.players)
  return _internal_players(index);
}
inline ::Protocol::PlayerInfo* S_MOVE::_internal_add_players() {
  return _impl_.players_.Add();
}
inline ::Protocol::PlayerInfo* S_MOVE::add_players() {
  ::Protocol::PlayerInfo* _add = _internal_add_players();
  // @@protoc_insertion_point(field_add:Protocol.S_MOVE.players)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::PlayerInfo >&
S_MOVE::players() const {
  // @@protoc_insertion_point(field_list:Protocol.S_MOVE.players)
  return _impl_.players_;
}
